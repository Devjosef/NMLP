...
SUGGESTION_RATE_LIMITED = (
    "Bottleneck at Hop {hop} ({host}) likely ICMP rate-limited. "
    "Final destination reachable with low loss. Not a critical transit fault."
)

SUGGESTION_CRITICAL = (
    "CRITICAL: Sustained packet loss at Hop {hop} ({host}) "
    "confirmed by forward-loss inheritance. This is a transit path fault."
)

SUGGESTION_UNSTABLE = "Unstable connection detected at Hop {hop} ({host})."
